...
const ethConfig = {
  1337: {
    ...
    privateKey: "91478b9ed07e05d331f3eb12be41541d61ffaefee8ccaec3249897c597814bf8", // account #9
  ...
  5: {
    ...
    recipientEthereum: process.env["ETHEREUM_GOERLY_ADDRESS"],
    privateKey: process.env["ETHEREUM_GOERLI_KEY"],
    unirisTokenAddress: process.env["UNIRIS_TOKEN_ADDRESS"]
  },
  1: {
